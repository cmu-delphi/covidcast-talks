...
date: "<br> ![](delphi.png) ![](cmu.png) <br><br> October 9, 2020"
footer: "Get the slides at: cmu-delphi.github.io/covidcast-talks/rmls.html"
output: 
  slidy_presentation:
    theme: cerulean
    highlight: tango
...
deaths = covidcast_signal(data_source = "usa-facts", 
                          ...
                          start_day = "2020-03-01", end_day = "2020-09-25",
...
cases = covidcast_signal(data_source = "usa-facts", 
                         ...
                         start_day = "2020-09-25", end_day = "2020-09-25")
...
sympt = covidcast_signal(data_source = "fb-survey", 
                         ...
                         start_day = "2020-04-15", end_day = "2020-09-25",
...
Much more to come! (Have an idea? File an issue or contribute a PR on our [public GitHub repo](https://github.com/cmu-delphi/covidcast))
...
Data available as of this week!
